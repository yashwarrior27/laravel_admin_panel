                ...
                <div class="row">
                    <form class="validate-form" action="{{route('static_pages.store')}}" method="post">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control"  type="text" id="title" name='title' placeholder="title" required value="{{$result->title??''}}" @if (isset($result))
                              disabled
                          @endif>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea    id="content" name='content'  placeholder="content" required>{{$result->content??''}}</textarea>
