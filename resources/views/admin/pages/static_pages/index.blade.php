 ...
 <div class="card border-bottom border-primary">
    <div class="card-body p-0 p-3">
        <div class="row">
            ...
            <div class="col-2">
                <a href="{{route('static_pages.create')}}" class="btn btn-success">Create</a>
            </div>
        </div>
    </div>
 </div>
            ...
            <table class="table table-striped  table-hover table-borderless pt-3 " id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><div>
                            <a href="{{route('static_pages.edit',$item->id)}}" class="btn rounded-pill btn-sm btn-warning">Edit</a>
                   ...
                   <h1>Are you sure?</h1>
                            ...
                            <div class="modal-footer border-bottom border-danger">
                                <form action="{{route('static_pages.destroy',$item->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
